...
/**
 * swap_next - Funct that swaps node with next node
...
/**
 * deck_len - Funct returns the length of a card deck
 * @h: The head node to the deck
...
/**
 * card_to_int - A funct that assigns a unique numeric value to each card
...
/**
 * sort_deck - A funct that sorts the deck with cocktail shaker
